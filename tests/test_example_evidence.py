...
class ExampleEvidenceTests(unittest.TestCase):
    def test_capture_matrix_and_runtime_checks_are_complete(self):
        ...
        self.assertEqual(result["metrics"]["captures"], 30)
        self.assertEqual(result["metrics"]["runtime_checks"], 39)
    ...
    def test_visual_baselines_cover_representative_surfaces(self):
        ...
        for baseline in ("prototype-wide.png", "prototype-mobile.png", "prototype-discover-wide.png", "prototype-circle-wide.png", "prototype-thread-wide.png", "prototype-profile-wide.png", "prototype-notifications-wide.png", "prototype-settings-wide.png", "board-wide.png"):
