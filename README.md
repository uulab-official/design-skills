...
`npm run test:browser` proves URL restoration, history-state rehydration, local font loading, search URL synchronization, composer focus return, mobile drawer focus return, 44px mobile touch targets, board dialog focus return, and skip-link navigation in Chromium.
...
The current roadmap is [`docs/superpowers/plans/2026-08-21-design-skills-v0.8-mobile-touch-contract.md`](docs/superpowers/plans/2026-08-21-design-skills-v0.8-mobile-touch-contract.md).
