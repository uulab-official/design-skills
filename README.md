...
`npm run test:browser` proves URL restoration, prototype and board history-state rehydration, local font loading, dedicated feed-status announcements, search URL synchronization, composer focus return, Like/Save action focus retention, Featured story CTA feedback, mobile drawer focus return, 44px mobile touch targets, board dialog focus return, and skip-link navigation in Chromium.
...
The current roadmap is [`docs/superpowers/plans/2026-08-21-design-skills-v0.13-featured-story-route-feedback.md`](docs/superpowers/plans/2026-08-21-design-skills-v0.13-featured-story-route-feedback.md).
